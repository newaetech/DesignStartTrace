...
set_property PACKAGE_PIN C11 [get_ports { TDO[0] }]
...
set_property PACKAGE_PIN D13 [get_ports { SWO }]
...
# --------------------------------------------------
set_output_delay  -clock [get_clocks slow_out_clk] -add_delay $untimed_id [get_ports SWO]
set_output_delay  -clock [get_clocks slow_out_clk] -add_delay $untimed_id [get_ports TDO[0]]
