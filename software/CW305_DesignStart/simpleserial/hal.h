...
// DesignStart stuff: TODO: not final resting place, should be in a
// platform-specific define, putting it here now out of convenience to get
// this started
#define init_uart InitialiseUART
#define trigger_setup InitialiseGPIO
#define putch outbyte
#define getch inbyte
#define trigger_high SetTrig
#define trigger_low ClearTrig
